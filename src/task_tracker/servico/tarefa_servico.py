...
class TarefaServico:
    ...
    def buscar_tarefa_por_id(self, id_buscar:int, todas_tarefas:list[Tarefa] = None):
        if todas_tarefas is None:
        ...
        raise ValueError(f"ID {id_buscar} não encontrado em lista de tarefas!")
    ...
    def atualizar_descricao_tarefa(self, id_digitado:int, nova_descricao:str):
        ...
        tarefa_encontrada = self.buscar_tarefa_por_id(id_digitado, todas_tarefas)
        
        tarefa_encontrada.atualizar_descricao(nova_descricao)
        self.repositorio.salvar_tarefas(todas_tarefas)
    ...
    def atualizar_status_tarefa(self, id_digitado:int, novo_status:StatusTarefa):
        ...
        tarefa_encontrada.atualizar_status(novo_status)
        self.repositorio.salvar_tarefas(todas_tarefas)
